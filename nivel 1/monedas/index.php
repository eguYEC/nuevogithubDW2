...
<head>
    ...
    body{
        ...
        *{
        ...
        .ico-calculadora{
             background:url('png/003-dollar.png') no-repeat center !important;
...
<div class='ctn-main'>
    <div class='ctn-form'>
        ...
        <div class='form-content'>
            ...
            <form action='cambio2.php' method='POST'>
            <div class='x-2'>
                <div class='ctn-control'>
                    <select name='op'>
                        <option value='0'>Tipos de Cambio</option>
                        <option value='1'>bs-usd</option>
                        <option value='2'>bs-eur</option>
                        <option value='3'>uds-bs</option>
                        <option value='4'>usd-eur</option>
                        <option value='5'>eur-bs</option>
            ...
            <div class='x-2'>
                <div class='ctn-control'>
                    <input type='text' name='cant' placeholder='Ingrese su Cantidad' />
                </div>
            </div>
            <div class='x-1'>
                <div class='ctn-control'>
