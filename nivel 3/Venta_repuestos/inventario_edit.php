...
$edit_id = isset($_GET['idinventario']) ? base64_decode($_GET['idinventario']) : null;
...
foreach ($listaInventarioTemp as $item) {
    if ($item->idinventario == $edit_id) {
        $repuestoEncontrado = $item;
        break;
    }
}
...
<head>
    ...
    <!-- Aquí puedes copiar y pegar tu CSS original -->
    <style>
        body{
            margin:0px;
        }
...
<div class='ctn-main'>
    <div class='ctn-form'>
        <div class='form-header'>
            ...
            <a href='inventario_list.php'><div class='btn-back'></div></a>
        </div>
        <div class='form-content'>
            <form action='inventario_update.php' method='POST'>
                <input type='hidden' name='id' value='<?php echo $repuestoEncontrado->idinventario ?>'>
                <div class='x-1'>
                    <div class='ctn-control'>
                        <input type='text' name='nom' value='<?php echo $repuestoEncontrado->producto ?>' placeholder='Nombre del repuesto'>
                    </div>
                </div>
                <div class='x-1'>
                    <div class='ctn-control'>
                        <input type='text' name='precio' value='<?php echo $repuestoEncontrado->precio ?>' placeholder='Precio'>
                    </div>
                </div>
                <div class='x-1'>
                    <div class='ctn-control'>
                        <input type='text' name='cant' value='<?php echo $repuestoEncontrado->cantidad ?>' placeholder='Cantidad'>
                    </div>
                </div>
                <div class='x-1'>
                    <div class='ctn-control'>
