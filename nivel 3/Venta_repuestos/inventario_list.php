...
foreach($listaInventarioTemp as $elemento){
    ...
    $inventario .= "<div class='card'>Codigo:".$elemento->idinventario."<br>Producto:". $elemento->producto ."<br> Precio: ".$elemento->precio."<br>
         Estado: <strong>" . ($elemento->estado == 1 ? "Activo" : "Anulado") . "</strong>
