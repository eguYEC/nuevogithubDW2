...
foreach($listaVentaTemp as $elemento){
    ...
    $ligas .= "<div class='card'>N°:". $elemento->idventa."<br> Nombre:".$elemento->nombre_cliente."<br> Precio Unitario: ".$elemento->precio_unitario."<br> Total Venta: ".$elemento->total_venta."<br>
        Producto:".$elemento->producto."<br>Cantidad: ".$elemento->cantidad."
