...
$Equipo1 = "";
for($i=0; $i < count($America); $i++){
    $Equipo1 .= "<option value='". $America[$i]["nombre"] ."'>". $America[$i]["nombre"] ."</option>";
}
$Equipo2 = "";
for($i=0; $i < count($Europa); $i++){
    $Equipo2 .= "<option value='". $Europa[$i]["nombre"] ."'>". $Europa[$i]["nombre"] ."</option>";
}
$Equipo3 = "";
for($i=0; $i < count($Africa); $i++){
    $Equipo3 .= "<option value='". $Africa[$i]["nombre"] ."'>". $Africa[$i]["nombre"] ."</option>";
}
$Equipo4 = "";
for($i=0; $i < count($Asia); $i++){
    $Equipo4 .= "<option value='". $Asia[$i]["nombre"] ."'>". $Asia[$i]["nombre"] ."</option>";
}
...
<div class='ctn-main'>
    <div class='ctn-form'>
        ...
        <div class='form-content'>
            ...
            <form action='res-1.php' method='POST'>
            <div class='x-1'>
