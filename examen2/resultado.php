...
foreach($tipoAlquiler as $herra){
    if( $herra->idAlquiler == $alquila  ){
        $tiempo = $herra->precio;
        $tiempo = $tiempo * $time;
        $venta = "Nombre:".$nom."<br>
               Precio: ".$tiempo."<br>";          
...
$venta2 = "";
foreach($tipoExtra as $herra){
    if ( $herra->idExtra == $extra ){
        $suma = $herra->precio;
        $suma = $suma + $tiempo;
        $venta2 = "Extra:".$herra->nombre."<br>
                Precio:".$herra->precio."<br>
               Precio total: ".$suma."<br>";          
    }
