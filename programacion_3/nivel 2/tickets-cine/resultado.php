...
for($i=0; $i < count($listaInmuebles); $i++){
    if ( $listaInmuebles[$i]["idTipo"] == $tipo ){
        $posiblesInmuebles .= "<div class='card'>Dir: " . $listaInmuebles[$i]["direccion"] . 
        "<br>Precio: <b>" . $listaInmuebles[$i]["precio"]. " Usd.</b>
        <br>Tel: <a href='tel:".$listaInmuebles[$i]["tel"]."'>" . $listaInmuebles[$i]["tel"]. 
         "</a></div>";
    }    
}
...
<div class='ctn-main'>
    <div class='ctn-form'>
        ...
        <div class='form-content'>
            <div class='card'>Cliente<br>
                <?php echo $nom ?> (<b><?php echo $tipo ?></b>)
            </div>
            Inmuebles
            <?php echo $posiblesInmuebles ?>
        </div>
    </div>
</div>
