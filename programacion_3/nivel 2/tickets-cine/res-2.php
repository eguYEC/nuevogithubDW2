...
for($i=0; $i < count($listaPelicula); $i++){
    if ( $listaPelicula[$i]["idPelicula"] == $idPelicula ){
        $tituloPelicula = $listaPelicula[$i]["titulo"];
        $precioPelicula = $listaPelicula[$i]["precio"];
    }
}
...
<div class='ctn-main'>
    <div class='ctn-form'>
        ...
        <div class='form-content'>
            ...
            <div class='card'>
                <?php echo $tituloPelicula ?>
                <hr>
                Cantidad: <?php echo $cantidad ?><br>
                Precio Unit.: <?php echo $precioPelicula ?><br>
