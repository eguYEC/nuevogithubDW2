        ...
        <div class='form-content'>
            ...
            <div class='x-1'>
                <div class='ctn-control'>
                    <select name='tipo'>
                        <option value='0'>Seleccione su Sector</option>
                        <option>curva</option>
                        <option>general</option>
                        <option>butacas</option>
                ...
                <div class='x-1'>
                <div class='ctn-control'>
                    <input type='text' name='mayor' placeholder='Mayor' />
                </div>
                </div>
                <div class='x-1'>
                <div class='ctn-control'>
                    <input type='text' name='menor' placeholder='Menor' />
                </div>
                </div>
                </div>
                <div class='x-1'>
