...
$opciones = "";
foreach($tipopizza as $elemento){
    $opciones .= "<option value='". $elemento->idTipo ."'>". $elemento->nombre ."</option>";
}
$tamaño = "";
foreach($tipotamaño as $element){
    $tamaño .= "<option value='". $element->idTamaño ."'>". $element->nombres ."</option>";
}

$zonas = "";
foreach($Zona as $Ubicacion){
    $zonas .= "<option value='". $Ubicacion->idZona ."'>". $Ubicacion->nombre ."</option>";
}
    ...
    <div class='ctn-form'>
        ...
        <div class='form-content'>
            ...
            <div class='x-1'>
                <div class='ctn-control'>
                    <select name='zona'>
                        <option value='0'>Seleccione Zona para Delivery</option>
                        <?php echo $zonas ?>
                    </select>    
                </div>
            </div>
