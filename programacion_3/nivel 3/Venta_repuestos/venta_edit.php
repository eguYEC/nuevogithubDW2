            ...
            <form method="POST" action="venta_update.php">
                <div class="form-content">
                    ...
                    <div class="x-1 ctn-control">
                        ...
                        <input type="text" name="nombre" value="<?php echo $ventaEncontrada->nombre; ?>" placeholder="Nombre del Cliente">
                    </div>

                    <div class="x-2 ctn-control">
                        <label>Cantidad</label>
                        <input type="number" name="cantidad" value="<?php echo $ventaEncontrada->cantidad; ?>" placeholder="Cantidad">
                    </div>
                    <div class="x-1 ctn-control">
                        <label>Fecha</label>
                         <input type="text" name="fecha" value="<?php echo $ventaEncontrada->fecha; ?>" placeholder="dd/mm/aa">
                    </div>
