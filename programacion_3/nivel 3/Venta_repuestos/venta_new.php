...
foreach($listaInventarioTemp as $elemento){
    $lista .= "<option value='". $elemento->idinventario ."'>". $elemento->producto ."</option>";
}
...
<div class='ctn-main'>
    <div class='ctn-form'>
        ...
        <div class='form-content'>
            ...
            <form action='venta_save.php' method='POST'>
                <div class='x-1'>
                ...
                <div class='x-1'>
                    <div class='ctn-control'>
                        <input type='text' name='nom' placeholder='Nombre del Cliente'>
                    </div>
                </div>
                <div class='x-1'>
                     <div class='ctn-control'>
                         <input type='text' name='fecha' placeholder='Fecha de Venta (dd/mm/aa)' />
                     </div>
                </div>
