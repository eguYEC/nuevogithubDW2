...
foreach($listaHerramientas as $herra){
    if ( $herra->idferre == $idferret ){
        $pres = $herra->precio;
        $total = $cand * $pres;
        $venta = "herramienta:".$herra -> nombre."<br>
               Precio c/u: ".$pres."<br>
               Cantidad:".$cand."<br> 
               Total: ".$total; 
...
<head>
    ...
    <style>
        ...
        *{
        ...
        .ico-calculadora{
            background:url('png/support.png') no-repeat center !important;
