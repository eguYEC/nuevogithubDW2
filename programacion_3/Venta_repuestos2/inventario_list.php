...
/*if ( isset($_SESSION["sLigas"]) ){
    $listaLigasTemp = unserialize($_SESSION["sLigas"]);
}else{
    $listaLigasTemp = $listaLigas;
}*/
...
/*function BuscarLiga($_lista, $_idLiga){
    $nomLiga = "";
    foreach($_lista as $elemento){
        if ( $elemento->idLiga == $_idLiga ){
            $nomLiga = $elemento->nombre;
        }
    }
...
foreach($listaInventarioTemp as $elemento){
    $idinventario = base64_encode($elemento->idinventario);
    //$idLiga = $elemento->idLiga;
    //$nomLiga = BuscarLiga($listaLigasTemp, $idLiga);
    //$opciones .= "<option value='". $elemento->idLiga ."'>". $elemento->nombre ."</option>";
    $equipos .= "<div class='card'>". $elemento->producto ." Precio: ".$elemento->precio."<br>Cantidad:".$elemento->cantidad."<br>
        <a href='inventario_edit.php?idInventario=". $idinventario ."'><div class='btn-edit'></div></a>
        <a href='inventario_delete.php?idInventario=". $idinventario ."'><div class='btn-delete'></div></a>
    </div>";
}
...
<div class='ctn-main'>
    <div class='ctn-form'>
        ...
        <div class='form-content'>
            ...
            <?php echo $equipos ?>
            <a href='inventario_new.php'><div class='btn-add'></div></a>
            </form>
        </div>
    </div>
</div>
