...
$opciones = "";
foreach($listaLigasTemp as $elemento){
...
<div class='ctn-main'>
    <div class='ctn-form'>
        <div class='form-header'>
            ...
            <a href='inventario_new.php'><div class='btn-back'></div></a>
        </div>
        <div class='form-content'>
            <!-- Contenido del Formulario -->
            <form action='inventario_save.php' method='POST'>
                <div class='x-1'>
                    <div class='ctn-control'>
                        <input type='text' name='nom' placeholder='Ingrese el nuevo respuesto'>
                    </div>
                </div>
                <div class='x-1'>
                    <div class='ctn-control'>
                         <input type='number' name='cantidad' placeholder='Ingrese la cantidade del nuevo equipo'>
                    </div>
                </div>
                <div class='x-1'>
                    <div class='ctn-control'>
