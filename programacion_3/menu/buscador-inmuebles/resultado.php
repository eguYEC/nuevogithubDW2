...
for ($i = 0; $i < count($listaInmuebles); $i++) {
    ...
    if ($listaInmuebles[$i][0] == $tipo && $listaInmuebles[$i][4] == $dato) {
        $posiblesInmuebles .= "<div class='card'>Dir: " . $listaInmuebles[$i][1] .
        "<br>Precio: <b>" . $listaInmuebles[$i][2] . " USD</b>" .
        "<br>Tel: <a href='tel:" . $listaInmuebles[$i][3] . "'>" . $listaInmuebles[$i][3] .
        "</a></div>";
    }
}
