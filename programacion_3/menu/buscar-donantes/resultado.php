...
for($i=0; $i < count($listaDonantes); $i++){
    if($listaDonantes[$i][1] == $grupo){
        $posiblesDonantes .= "<div class='card'>" . $listaDonantes[$i][0].
        "<br>". $listaDonantes[$i][2]."</div>";
    }
}
...
<div class='ctn-main'>
    <div class='ctn-form'>
        ...
        <div class='form-content'>
            <div class = 'card'>Paciente<br>
                <?php echo $nom ?>
            </div>
            Donantes Compatibles
            <?php echo $posiblesDonantes ?>
        </div>
    </div>
</div>
