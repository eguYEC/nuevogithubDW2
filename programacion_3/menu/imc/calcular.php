...
if ( $_POST["peso"] != "" and $_POST["altura"] != "" ){
...
$result = "Su índice de masa corporal es: " . $imc;

    if ( $imc < 18.5 ){
        $result .= "<hr>Bajo Peso";
    }else if( $imc < 24.9 ){
        $result .= "<hr>Peso Normal";
    }else if ( $imc < 29.9 ){
        $result .= "<hr>Sobrepeso";
    }else if ( $imc < 34.9){
        $result .= "<hr>Obesidad I";
    }else if ( $imc < 39.9 ){
        $result .= "<hr>Obesidad II";
    }else{
        $result .= "<hr>Obesidad III";
    }

}else{
    $result = "Ingrese los datos necesarios!";
}
